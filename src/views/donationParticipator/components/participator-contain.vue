<template lang="html">
    <section>
        <h2>欢迎进入<span>{{school}}</span>捐赠专场</h2>
        <p class="holder"><a v-link="{path:'schooldonator'}">外校入口</a></p>
        <p class="holder"><a v-link="{path:'schooldonation'}">举办方入口</a></p>
        <div class="new"><span>填写信息（请填写以下信息，方便举办方联系您）</span></div>
       <!--  <form method="POST">
        ...
        <div class="goodsinfo" >
            ...
            <div class="caption">
               ...
               <div class="caption-right">
                   <input type="text" placeholder="帖子标题"  >
                   <span :style="captionStyle">字数在8字以内</span>
               </div>
            </div>
            <div class="price">
               <div class="price-left">
        ...
        <div class="btn">
            <input type="button" value="提交" class="btn btn-left"></input>
